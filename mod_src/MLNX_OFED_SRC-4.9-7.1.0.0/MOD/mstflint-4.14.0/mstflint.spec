...
Source: http://www.openfabrics.org/downloads/mstflint-4.14.0-3.tar.gz
...
%define boost_filesystem_lib libboost_filesystem
%define boost_regex_lib libboost_regex
%else
